...
class Agent_DQN(Agent):
    def __init__(self, env, args):
        ...
        if args.test_dqn:
            ...
            self.online_model = load_model('./model/dqn_keras_online_model_g0.999.h5')
            self.env = env
    ...
    def train(self):
        ...
        for e in range(1, episodes+1):
            ...
            if (e%100) == 0:
                np.save('./result/dqn_keras_result_g0.999.npy',result)
                self.online_model.save('./model/dqn_keras_online_model_0.999.h5')
                self.target_model.save('./model/dqn_keras_target_model_0.999.h5')
